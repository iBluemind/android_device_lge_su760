...
TARGET_KERNEL_CONFIG := cyanogenmod_su760_defconfig
...
KERNEL_SGX_MODULES:
	make -C device/lge/su760/sgx-module/eurasia_km/eurasiacon/build/linux2/omap4430_android/ O=$(KERNEL_OUT) KERNELDIR=$(ANDROID_BUILD_TOP)/$(KERNEL_SRC) ARCH="arm" $(ARM_CROSS_COMPILE) KERNEL_CROSS_COMPILE=$(ARM_CROSS_COMPILE) TARGET_PRODUCT="blaze_tablet" BUILD=release TARGET_SGX=540 PLATFORM_VERSION=4.0 
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/lge/su760/bluetooth
...
TARGET_SPECIFIC_HEADER_PATH := device/lge/su760/src-headers
PRODUCT_VENDOR_KERNEL_HEADERS := device/lge/su760/kernel-headers
